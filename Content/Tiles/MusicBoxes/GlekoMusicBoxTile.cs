...
{
    class GlekoMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            //MusicLoader.AddMusicBox(Type, MusicLoader.GetMusicSlot(Mod, "Assets/Music/NightOfGadza"),
                //ModContent.ItemType<GlekoMusicBox>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<GlekoMusicBox>();
        }
