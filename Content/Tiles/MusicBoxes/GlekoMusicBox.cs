...
namespace FinalFantasy.Content.Tiles.MusicBoxes
{
    public class GlekoMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/NightOfGadza"), ModContent.ItemType<GlekoMusicBox>(), ModContent.TileType<GlekoMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<GlekoMusicBoxTile>(), 0);
        }
    }
}