...
{
    public class NightOfGadza : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/NightOfGadza"), ModContent.ItemType<NightOfGadza>(), ModContent.TileType<GlekoMusicBoxTile>());
        }
